...
def main():
    ...
    parser.add_argument('--num-episodes', type=int, help='number of running episodes')
    ...
    parser.add_argument('--load-mem', action='store_true',
    ...
    parser.add_argument('--save_score_log', default=True, type=bool,
